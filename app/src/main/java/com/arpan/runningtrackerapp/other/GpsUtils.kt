package com.arpan.runningtrackerapp.other
...
import com.arpan.runningtrackerapp.other.Constants.GPS_REQUEST
    ...
    fun turnGPSOn(onGpsListener: onGpsListener?) {
        if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            ...
            mSettingsClient
                    ...
                    .addOnSuccessListener((activity)) { //  GPS is already enable, callback GPS status through listener
                        onGpsListener?.gpsStatus(true)
                    }
